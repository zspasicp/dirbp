...
-- distributed transaction and XA support for the Microsoft SQL Server JDBC Driver 2.0.
...
--     JDBC Driver 2.0 are granted through the SQL Server role [SqlJDBCXAUser].  To maintain a secure default 
